...
@interface SCNavigationDropdownMenu () <UITableViewDataSource, UITableViewDelegate>
...
@implementation SCNavigationDropdownMenu

- (instancetype)init {
    self = [SCNavigationDropdownMenu buttonWithType:UIButtonTypeCustom];
    if (self) {
...
- (void)menuAction:(SCNavigationDropdownMenu *)sender {
...
- (void)setDataSource:(id<SCNavigationDropdownMenuDataSource>)dataSource {
    _dataSource = dataSource;
    [self setTitle:self.titleArray.firstObject forState:UIControlStateNormal];
}

- (void)setDelegate:(id<SCNavigationDropdownMenuDelegate>)delegate {
    _delegate = delegate;
...
- (UIColor *)cellSelectedColor {
    if ([self.dataSource respondsToSelector:@selector(cellSelectionColorForNavigationDropdownMenu:)]) {
        return [self.dataSource cellSelectionColorForNavigationDropdownMenu:self];
    } else {
        return nil;
    }
}
